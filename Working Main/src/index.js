...
app.post('/formsubmitted', async (req, res) => {
    ...
    try {
        ...
        const executeCommand = `cd "C:\\Users\\narsi\\OneDrive\\Desktop\\KMEC PS 2-1_HEART HEALTH_22 Batch\\ML Model" && python ${pythonScriptPath} ${formDataString}`;
...
app.post('/previous-records', async (req, res) => {
    try {
        ...
        res.render('prevRecords', { user, entry });
